...
export default function Career () {
    ...
    function ShinyTech(props: { tech: string }) {
        return <span className="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent font-normal w-fit">{props.tech}</span>
    }
    ...
    return (
        <>
            <PageDescription title="Career" description="My professional background and my projects." />
