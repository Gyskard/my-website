<template>
  <button type="button"
    class="btn btn-primary collapse-toggle"
    id="basic-collapse"
    aria-expanded="false"
...
>
  ...
  <span class="hidden collapse-open:block">Collapse</span>
  <span class="transition-rotate icon-[tabler--chevron-down] size-4 duration-300 collapse-open:rotate-180"></span>
</button>
<div
...
>
  <div class="mt-3 rounded-md border border-base-content/25 p-3">
